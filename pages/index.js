      ...
      <div className="w-full h-full">
        <div className="text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto">
          ...
          >
            ...
            <br />
            <br />
            With over a decade of support, I excel in troubleshooting, securing
            networks, and optimizing IT through scripting and CI/CD. Eager to
            enhance organizations with smooth IT operations
          </motion.p>
          {/*Button*/}
